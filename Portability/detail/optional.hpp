 ...
 *
 * This file contains the definition for std::optional if one does not exist,
 * it is taken from std::experimental::optional
 */
...
/**
 * bring it into the std namespace if not compiling with C++17
 */
namespace std {
